...
const fs = require("fs");
const jsonFile = "build/contracts/CarbonCreditToken.json";
const artifact = JSON.parse(fs.readFileSync(jsonFile));
...
// const CarbonCreditToken = new web3.eth.Contract(abi, "0x36dCc08e19777f1c5d5d937fA4f02028ee3F277F");
